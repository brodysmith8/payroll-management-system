		...
		<div class="w-full px-4 md:px-6 text-xl text-gray-800 leading-normal" style="font-family:Georgia,serif;">
			...
			<div class="font-sans">
				...
				<p class="text-base md:text-sm text-green-500 font-bold text-center"><a href="/features/five" class="text-base md:text-sm text-green-500 font-bold no-underline hover:underline">NEXT &gt;</a></p>
						<h1 class="font-bold font-sans break-normal text-gray-900 pt-6 text-3xl -mb-0.5 md:text-4xl">Feature Four</h1>
						<p class="text-sm md:text-base font-normal text-gray-600 pb-3"><strong class="small-caps text-gray-900">Query:</strong> find the branch with the highest pay-per-employee</p>
			</div>
